...
public class AddEmployeeSteps extends CommonMethods {
    ...
    @When("user enters firstname {string} and middlename {string} and lastname {string}")
    public void user_enters_firstname_and_middlename_and_lastname(String string, String string2, String string3) {
...
@Then("verify the data from frontend and backend")
    ...
    Assert.assertEquals(GlobalVariables.dbFirstName,GlobalVariables.dbFirstName);
    Assert.assertEquals(GlobalVariables.dbMiddleName,GlobalVariables.dbMiddleName);
    Assert.assertEquals(GlobalVariables.dbLastName,GlobalVariables.dbLastName);
